...
public class CartPageSteps {
	...
	@When("Select the payment method")
	...
	public void fill_in_the_recipients_details_with_blank_field_name(String name) {
		fillInRecipientsDetails(name);
	}
	
	@Then("Checks if there {string} is warning sign")
	public void checks_if_there_is_warning_sign(String name) {
